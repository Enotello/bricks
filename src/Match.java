...
class Match {
	...
	public Match() {
		...
		_lib[3] = _pf.getToolkit().getImage("hard_brick.gif");
		_lib[4] = _pf.getToolkit().getImage("brick_sticky.gif");
	...
	public void start() {
		...
		_bp = new BrickPile(_pf, _lib[2], _lib[3], _lib[4]);
